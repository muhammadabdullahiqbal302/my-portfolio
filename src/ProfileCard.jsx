  ...
  return (
    <div className="float-graph">
      <div className="float-graph__bars">
        {GRAPH_BARS.map((h, i) => (
          <div key={i} className={`float-graph__bar ${revealed ? 'revealed' : ''}`}
            style={{ '--h': `${h}%`, '--i': i }} />
        ))}
      </div>
  ...
  return (
    <div className="float-donut">
      <svg width="52" height="52" viewBox="0 0 52 52">
        ...
        <circle cx="26" cy="26" r={radius} fill="none" stroke="url(#donutGrad)" strokeWidth="6"
        ...
        />
        <text x="26" y="30" textAnchor="middle" fill="currentColor" fontSize="9" fontWeight="800">
          {revealed ? `${percent}%` : ''}
        </text>
      </svg>
